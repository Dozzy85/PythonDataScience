...
np.reshape(mydata, (5, 4)) #Primo parametro righi=5 secondo paramtro colonne=4
MATR1 = np.reshape(mydata, (5, 4), order='C') # riempe prima le righe e poi le colonne
MATR2 = np.reshape(mydata, (5, 4), order='F') # riempe prima le colonne e poi le righe
print(MATR1)
#Come leggere il valore 10 della matrice
print(MATR1[2,2])
print(MATR2[0,2])

#OOP Concept:
MATR3 = mydata.reshape(5,4)
print(MATR3)
...
plt.plot(Salary[6], c='Black', ls='--', marker='^', ms='7', label = Players[6])
plt.plot(Salary[7], c='Black', ls='--', marker='D', ms='7', label = Players[7])
plt.plot(Salary[8], c='Black', ls='--', marker='s', ms='7', label = Players[8])
plt.plot(Salary[9], c='Black', ls='--', marker='o', ms='7', label = Players[9])
plt.legend(loc='upper left', bbox_to_anchor=(1,1)) #imposto la leggenda che viene mostrata sul grafico, con loc='upper left' la leggenda viene
                                                   #mostrata nella parte in alto a sinistra, con bbox_to_anchor=(1,1) imposto la posizione di
                                                   #dove deve ancorarsi
...
plt.plot(Games[6], c='Black', ls='--', marker='^', ms='7', label = Players[6])
plt.plot(Games[7], c='Black', ls='--', marker='D', ms='7', label = Players[7])
plt.plot(Games[8], c='Black', ls='--', marker='s', ms='7', label = Players[8])
plt.plot(Games[9], c='Black', ls='--', marker='o', ms='7', label = Players[9])
